...
export const YAKLASIM_LISTE = [
  { deger: 1, ad: "Siyah", aciklama: "Başka Parti", bg: "#1f2937", fg: "#ffffff", kenar: "#111827" },
  { deger: 3, ad: "Gri", aciklama: "Kararsız seçmen", bg: "#9ca3af", fg: "#ffffff", kenar: "#6b7280" },
  { deger: 5, ad: "Beyaz", aciklama: "AK Parti", bg: "#ffffff", fg: "#111827", kenar: "#cbd5e1" },
];
